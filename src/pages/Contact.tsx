...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-gaming-dark">
      ...
      {/* Hero Section */}
      <section
        className="relative min-h-screen flex items-center  bg-gaming-darker bg-cover bg-[url(@/assets/CROW_-_ARENA_BOSS_SKETCH_BW_GRAND_ANGLE_-_03_OCTOBER_24_-_1.jpg)]"
      >
        <div className="absolute inset-0 bg-gradient-hero opacity-70"></div>
        <div className="absolute inset-0 bg-grid-pattern opacity-20"></div>

        <div className="flex-1 z-10 px-16">
          <h1 className="text-6xl md:text-8xl font-bold text-gaming-gold mb-8">
            CONTACT US
          </h1>

          <div className="flex-1 space-y-4 text-gaming-text text-4xl mb-12">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <form onSubmit={handleSubmit} className="space-y-8">
            <div>
              <Label
                htmlFor="name"
                className="text-gaming-text text-sm font-medium mb-4 block"
              >
                Name (required)
              </Label>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <Label
                    htmlFor="firstName"
                    className="text-gaming-text-muted text-xs mb-2 block"
                  >
                    First Name
                  </Label>
                  <Input
            ...
            <div>
              <Label
                htmlFor="email"
                className="text-gaming-text text-sm font-medium mb-2 block"
              >
                Email (required)
              </Label>
              <Input
